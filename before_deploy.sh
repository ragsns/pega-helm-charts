...
git clone -b gh-pages https://github.com/ragsns/pega-helm-charts.git xx && rm -rf charts .github docs linux-amd64 terratest xx && rm -rf xx/.git && rm -rf xx/.github && cp -r xx/* . && rm -rf xx
